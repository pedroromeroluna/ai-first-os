...
| When | From / to |
|---|---|
| The Research Plan from `ux-research` already has a v1 guide | Entry from `ux-research` (`packs/product-builder/skills/ux-research.md`) |
...
| After real fieldwork | The complete research of the pipeline feeds the strategic layer that `prd` writes (`packs/product-builder/skills/prd.md`) |
...
fieldwork —transcripts into findings— is not the job of this skill.
