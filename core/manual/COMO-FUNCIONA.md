...
| `orgs/<nombre>/products/<slug>/context.md` | Qué es un producto, para quién, y qué se sabe de él |
...
**Dónde viven los skills**, porque es lo primero que todo el mundo pregunta: los diez skills del
...
El catálogo de abajo es el sistema mismo — las diez herramientas que vienen con él. También podés
...
- **`new-product`** — Suma un producto a una organización que ya existe.
...
Esas diez hacen andar el sistema. **El oficio —construir producto, y lo que venga después— llega en
