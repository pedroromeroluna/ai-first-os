...
<!--count-->dieciséis<!--/count--> skills del sistema están en `.os/core/skills/`, un archivo cada uno, y
...
El catálogo de abajo es el sistema mismo — las <!--count-->dieciséis<!--/count--> herramientas que vienen
...
Esas <!--count-->dieciséis<!--/count--> hacen andar el sistema. **El oficio —construir producto, y lo que
