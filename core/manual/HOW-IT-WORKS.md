...
<!--count-->sixteen<!--/count--> skills of the system are in `.os/core/skills/`, one file each,
...
The catalog below is the system itself — the <!--count-->sixteen<!--/count--> tools that come with
...
Those <!--count-->sixteen<!--/count--> run the system. **The craft —building product, and whatever
