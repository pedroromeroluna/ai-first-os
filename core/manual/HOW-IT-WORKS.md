...
| `orgs/<name>/products/<slug>/context.md` | What a product is, for whom, and what is known about it |
...
**Where the skills live**, since it is the first thing everyone asks: the ten skills of the
...
The catalog below is the system itself — the ten tools that come with it. You can also invoke any
of them by name.
...
- **`new-product`** — Add a product to an organization that already exists.
...
Those ten run the system. **The craft —building product, and whatever comes next— arrives in
